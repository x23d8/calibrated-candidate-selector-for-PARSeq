...
Kết luận thực nghiệm hiện tại: `clahe_clip1_tile4` là phương pháp tiền xử lý phù
hợp nhất với checkpoint đã huấn luyện. Các mô hình enhancement tổng quát như
Real-ESRGAN, Restormer và Zero-DCE chưa cải thiện tốt hơn ảnh RGB gốc hoặc CLAHE.
...
3. Benchmark 47 cấu hình tiền xử lý ảnh truyền thống.
...
- dùng `clahe_clip1_tile4` làm ứng viên tiền xử lý;
